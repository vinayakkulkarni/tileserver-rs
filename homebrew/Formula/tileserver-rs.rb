...
class TileserverRs < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/vinayakkulkarni/tileserver-rs/releases/download/v#{version}/tileserver-rs-macos-arm64.tar.gz"
      # SHA256 is auto-updated by GitHub Actions on release
      sha256 "TODO"
    end
  end
